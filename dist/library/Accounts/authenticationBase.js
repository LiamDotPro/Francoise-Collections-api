...
var baseUserFunctions = function () {
    ...
    _createClass(baseUserFunctions, [{
        ...
        value: function findAccountById(id) {
            return _bluebird2.default.using((0, _db2.default)(), function (connection) {
                return connection.query('SELECT id,userName FROM `accounts` WHERE id=?', [id]).then(function (res) {
                    if (res.length > 0) {
                        return {
                            name: res[0].name,
        ...
        value: function getUserPasswordHash(userID) {
            return _bluebird2.default.using((0, _db2.default)(), function (connection) {
                return connection.query('SELECT Password from `accounts` WHERE id=?', [userID]).then(function (res) {
        ...
        value: function insertNewHashedPassword(id, password) {
            return this.encryptPassword(password).then(function (hash) {
                return _bluebird2.default.using((0, _db2.default)(), function (connection) {
                    return connection.query('UPDATE `accounts` SET Password=? WHERE id=?', [hash, id]).then(function () {
                        return {
                            status: 'ok',
