...
describe('Inventories', function () {
    ...
    describe('Inventories Library', function () {
        ...
        it('Should delete the newly created inventory', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
            var result;
                ...
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        ...
                        case 2:
                            ...
                            return _context7.abrupt('return', assert.isTrue(result, result.msg));
