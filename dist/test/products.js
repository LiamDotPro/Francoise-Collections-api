...
describe('Products', function () {
    describe('Products Base Library', function () {
        ...
        it('Should validate that the product has had its title updated', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
            var result;
        ...
        it('Should delete the previously made product', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
            var result;
                ...
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        ...
                        case 2:
                            ...
                            return _context7.abrupt('return', assert.isTrue(result, "Record could not be deleted.."));
